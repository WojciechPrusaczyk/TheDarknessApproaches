...
This was my **first project in Unity**, built with the game jam team in 24 hours. The code is rough in places and the repo contains Unity-generated files that should have been gitignored — I know, I learned that lesson here. The project is archived and not actively maintained.
